...
import com.ulasgokce.myapplication.Utils.ViewPostFragment;
import com.ulasgokce.myapplication.Utils.ViewProfileFragment;
    ...
    private void init() {
        ...
        if (intent.hasExtra(getString(R.string.calling_activity))) {
            ...
            if (intent.hasExtra(getString(R.string.intent_user))) {
                Log.d(TAG, "init: inflating new profile");
